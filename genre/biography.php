<?php
    ...
    $searchQuery = array("genre" => "Biography");
    if($collection->count($searchQuery) <= 0){
        header("Location: ../pages/home.php?flag=10");
    }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="nav navbar-nav mr-auto">
                ...
                <li class="dropdown">
                  <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Genre <span class="caret"></span></a>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../pages/new.php">New <span class="sr-only">(current)</span></a>
                </li>
              </ul>
              <form role="search" class="form-inline mt-2 mt-md-0" method="post" action="../pages/search.php">
              ...
              <form class="form-inline mt-2 mt-md-0" action="../pages/login.php" method="post">
                  <button class="btn btn-dark" style="margin-left: 10;" type="submit">Logout</button>
              </form>
            </div>
        </div>
      </nav>
              ...
              <tbody style="overflow-y: auto, height: 230px, width:100%">
                ...
                <tr>
                  ...
                  <td class="text-center" width="25%">
                      <a class='btn btn-info btn-sm' href='../pages/record_update.php?id=<?php echo $value[_id]; ?>'> Edit </a> 
                      <a onClick ='return confirm("Delete this movie?");' href='../pages/record_delete.php?id=<?php echo $value[_id]; ?>' class="btn btn-danger btn-sm"> Del </a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
