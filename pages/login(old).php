...
<html lang="en">
  ...
  <body class="text-center" style='background-image: url("asset/img/603033247.jpg")'>
      ...
      <button style="border-color: #E7F7EE; background-color: #194F65" class="btn btn-lg btn-primary btn-block" name="submit" type="submit">Sign in</button>
    </form>
<!--     </div> -->
  </body>
  <!-- JS Files -->
