<?php
    ...
    $cursor = $collection->find()->skip(15)->limit(15);
?>
<html lang="en">
  <head>
    <meta charset="utf-8">
        ...
        <div class="overflow-x:auto p53" style="margin-top:-50">
          <table class="table table-hover table-striped table-dark">
              ...
              <tbody style="overflow-y: auto, height: 230px, width:100%">
                <?php $sn = 15; foreach ($cursor as $id => $value){ ?>
                <tr>
              ...
              <tfoot>
                  <tr>
                      <div class="row">
                          <td colspan="10">
                              <button onclick='location.href="home.php"' class="btn btn-info btn-md" type="submit" style="color: white;">
                                  <img src="../asset/img/prev.png" /> Previous Page
                              </button>
                          </td>
                          <td>
                              <button  onclick='location.href="home3.php"' class="btn btn-info btn-md" style="color: white;">
